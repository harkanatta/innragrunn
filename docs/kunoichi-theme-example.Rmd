...
<br>
# .orange[Þær eru þráðlaga, kúlulaga,] .black[reglulegar] og 
# .orange[óreglulegar að lögun]
<br>
## .black[Sumar gerðir] .red[fljóta] .black[en aðrar] .red[sökkva] .black[eða mara í hálfu kafi í sjónum]
]]
.column.bg-main3[.content[
# Erfitt .yellow[að sjá], og vandasamt að .yellow[rannsaka].
<br>
...
.column.bg-main1[.content[
 ...
 ```{}
 Mest magn kemur frá bifreiðaumferð
 ```
 ]]
  .row[.content[
     # Málning
 ```{}
 Næstmest kemur frá málningu
 ```
 ]]
   .row[.content[
      # Fleiri minni þættir
...
class: hide-row2-col1 hide-row3-col1 with-thick-border

```{r Sank, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, out.height="100%"}
...
class: fade-row1-col1 hide-row3-col1 with-thick-border 
count: false

```{r eval=FALSE, message=FALSE, warning=FALSE, include=FALSE, out.height="100%"}
rammi
```
...
class: fade-row1-col1 fade-row2-col1 with-thick-border
count: false
