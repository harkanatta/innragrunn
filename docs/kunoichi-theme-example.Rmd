...
# .black[Erfitt] .yellow[að sjá] .black[ og vandasamt að] .yellow[rannsaka.]
<br>
...
### Helstu farleiðir örplasts á Íslandi eru í þéttbýli, þar sem það berst með ofanvatni í fráveitukerfin og þaðan til hafs.
<br>
### Í dreifbýli rennur ofanvatn að mestu í jarðveg.
  ]]
  .row.bg-main2[.content[
### Hægt er að skipta Íslandi upp í fjögur megin vatnasvæði. Á SV-horninu er vatnasvæði sem rennur út í Faxaflóa
  ]]
  .row.bg-main4[.content[
### Þar sem mest umsvif eru þar er mest örplastmengun 
  ]]
